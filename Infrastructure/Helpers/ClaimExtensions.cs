            ...
            foreach (var module in modules)
            {
                ...
                foreach (var fi in fields)
                {
                    ...
                    if (propertyValue is not null)
                        allPermissions.Add(new RoleClaimResponse { Value = propertyValue.ToString()!, 
                            Type = ApplicationClaimTypes.Permission, Group = moduleName, Description = moduleDescription });
                }
            }
