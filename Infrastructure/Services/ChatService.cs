...
namespace Infrastructure.Services
{
    public class ChatService : IChatService
    {
        ...
        public async Task<IResult<IEnumerable<ChatHistoryResponse>>> GetChatHistoryAsync(string userId, string contactId)
        {
        ...
        public async Task<IResult<IEnumerable<ChatUserResponse>>> GetChatUsersAsync(string userId)
        {
